        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CACCertificate = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyFoods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyFoods_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyFoods_Foods_FoodId",
                        column: x => x.FoodId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Directors_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "varchar(255)", nullable: false),
                    BranchId = table.Column<string>(type: "varchar(255)", nullable: false),
                    RiderPermit = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyFoods_CompanyId",
                table: "CompanyFoods",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyFoods_FoodId",
                table: "CompanyFoods",
                column: "FoodId");
